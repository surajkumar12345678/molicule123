                ...
                <div class="modal-body">
                  <div class="col-md-12">
                    <div class="">
                      ...
                      <div class="box-body">
                        <form action="/AddBlogCategory" method="POST" enctype="multipart/form-data"> @csrf <div class="form-group row">
		...
		<div class="modal fade" id="DeleteCategory{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="DeleteCategoryLabel{{ $category->id }}" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-footer">
				<a href="{{ route('DeleteBlogCategory', ['id' => $category->id]) }}" class="btn btn-primary mx-5">Yes</a>
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
			  </div>
			</div>
		  </div>
			  ...
			  <div class="modal-body">
				<div class="col-md-12">
				  <div class="">
					...
					<!-- <div class="box-divider m-a-0"></div> -->
					<div class="box-body">
					  <form action="{{ route('UpdateBlogCategory', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data"> @csrf <div class="form-group row">
						  <label class="col-sm-2 form-control-label">Category Name</label>
						  <div class="col-sm-10">
...
function toggleClass() {
	...
	$('.data-table').DataTable({
		...
		"serverSide": true,
		"ajax":{
		"url": "{{ url('/merchant/blog-category-management') }}",
		"dataType": "json",
		"type": "GET",
	  },
