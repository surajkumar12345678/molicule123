...
$cate = $blog->blog_category_id ?? null;
@endphp
...
<div class="padding">
    ...
    <div class="box">
        ...
        <div class="container table-responsive">
            <form action="{{ url('merchant/AddBlog')}}" method="POST" enctype="multipart/form-data" class="container">
                @csrf
                    ...
                    <div class="col-md-10">
                        <select name="category" class="form-control" required> 
                          ...
                          @foreach($categories as $category)
                            <option @if($cate == $category->id) selected @endif value="{{ $category->id }}">{{ $category->category_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-md-10">
                        ...
                        <p>
                            <img id="output" width="100" @if($image)
                                        src="{{asset('/uploads/blogs')}}/{{$image}}" @endif>
                        </p>
                        @error('images')
                        <p class="alert" style="color:red">{{ $message }}</p>
                        @enderror
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea type="text" rows="4" cols="50" name="body" id="body"
