...
<div class="padding">
    ...
    <h3 style="color:#1F85EC">Order Details</h3>
    <div class="box">
            ...
            <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$count}}</td>
                        <td>
                            <img src="{{ asset('uploads/products/images/'.$saledetail->product_image)}}" alt="producats1"
                                class="img-fluid " style="width: 62px;">
                        ...
                        <td>
                            @if($saledetail->payment_status == '0') 
                                <span class="label-warning label label-default">pending</span> 
                            @else
                                <span class=" btn btn-success label">Success</span> 
                            @endif
                        </td>
                ...
                <tfoot>
                    ...
                    <tr style="">
                        ...
                        <td><a class="btn btn-info btn-sm text-white" href="{{ url('order-approve')}}/{{$sale->id}}"><i class="fa fa-check" aria-hidden="true">Approve</i></a>
                        </td>
                        @endif
                        @if($sale->status != 3 && $sale->status != 4 && $sale->status != 5)
                        <td><a class="btn btn-danger btn-sm text-white" data-toggle="modal" data-target="#cancellModal{{$sale->id}}"><i class="fa fa-check" aria-hidden="true">Cancel</i></a></td>
                        @endif
                    </tr>
                </tfoot>
            </table>
