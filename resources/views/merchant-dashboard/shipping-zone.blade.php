...
<div class="padding">
    ...
    <div class="box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h3 style="color:#1F85EC">Add Country Zone</h3>
        ...
        <div class="container table-responsive">
            <form action="{{ route('shipping.zone')}}" method="POST" enctype="multipart/form-data" class="container">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="zone" class="form-control" placeholder="Enter Zone Name"  required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="zone_code" class="form-control" placeholder="Enter Zone Code"  required>
                    </div>
                </div>
