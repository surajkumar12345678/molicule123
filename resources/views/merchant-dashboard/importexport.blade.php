...
<div class="padding">   
    ...
    <div class="box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-2">
                    <a class="btn btn-success" href="{{ route('file-export') }}">Export Products</a>
                </div>
                <div class="col-sm-110">
                    <h3 style="color:#1F85EC">Products Import in Excel</h3>
                </div>
            </div>
        </div>
        <hr>
            ...
            <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="">
                    <div class="custom-file text-left">
                        <input required type="file" name="file" class="form-control" id="" placeholder="Choose Excel file">
                    </div>
                </div>
                <br><br>
