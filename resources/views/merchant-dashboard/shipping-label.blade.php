...
<div class="padding">
    ...
    <div class="box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h3 style="color:#1F85EC">Shipping Label</h3>
        ...
        <div class="container table-responsive">
            <form action="{{ route('shipping.label.insert')}}" method="POST" enctype="multipart/form-data" class="container">
                @csrf
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="label" class="form-control" placeholder="Enter Label Name"  required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-10">
                      <textarea name="address" class="form-control" rows="2" cols="2" placeholder="Enter Address" required></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-2">
