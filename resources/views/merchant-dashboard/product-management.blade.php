...
<div class="padding">
    ...
    <h3 style="color:#1F85EC">Product List</h3>
    <div class="box">
        ...
        <div class="container">
          <div class="row">
                <div class="col-sm-2">
                    <a type="button" class="btn btn-primary" href="{{route('add-products')}}"> Add Product </a>

                    <!-- <button class="btn btn-sm white">Apply</button>                 -->
                </div>
                <div class="col-sm-3">
                    <a href="{{route('file-import')}}" class="btn btn-primary">Import Products in Excel</a>
                </div>
