    ...
    <div class="padding">
        <div class="container">
                ...
                <div class="box-body m-5">
                    <form action="/merchant/add-page" method="POST" enctype="multipart/form-data">
                        @csrf  

                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label">Title</label>
                            <div class="col-sm-10">
                                <input type="text" onkeyup="myFunction()" name="title" id="title" class="form-control" placeholder="Title" required>
                            </div>
                                            @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea type="text" rows="4" cols="50" name="body" id="body" class="form-control" ></textarea>
                            </div>
                                            @error('body')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
