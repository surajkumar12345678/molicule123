...
<div class="padding">
    ...
    <div class="box">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <h3 style="color:#1F85EC">Add Order</h3>
                    <a href="{{ route('admin.order.status.check')}}" class="btn btn-primary">View All Orders</a>
                </div>
        ...
        <div class="container table-responsive">
            <form action="{{ route('admin.order.status')}}" method="POST" enctype="multipart/form-data" class="container">
                @csrf
				...
				<div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="paid" class="form-control" placeholder="Enter Paid" required>
                    </div>
				...
				<div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="report" class="form-control" placeholder="Enter Report" required>
                    </div>
