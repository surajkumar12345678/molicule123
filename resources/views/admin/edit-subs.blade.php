            ...
            <form action="{{ route('update-subscriptions', [$subscription->id]) }}" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            id="validity" type="number" name="validity_in_days"
                            value="{{ $subscription->validity_in_days }}" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            ...
                            value="{{ $subscription->number_of_product_allowed }}" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input
                            class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                            id="price" type="number" min="1" name="price" value="{{ $subscription->price }}" />
                        @error('price')
                        <small class="text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea
                            ...
                            name="description">{{ $subscription->description }}</textarea>
                        @error('description')
                        <small class="text-red-500">{{ $message }}</small>
                        @enderror
                    </div>
